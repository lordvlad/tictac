 ...
 * three ways a side's picture of the enemy can differ from the truth, since
 * each is a way the old omniscient policy was wrong.
 */
describe('what a side knows about the other', () => {
