...
| [ADR-0003](./0003-p2p-jsonrpc-replication.md) | P2P JSON-RPC 2.0 State Replication & Sender-Resolved Combat | Implemented / partly superseded by [ADR-0004](./0004-full-knowledge-lockstep.md) | 2026-09-14 | Networking / Wire |
| [ADR-0004](./0004-full-knowledge-lockstep.md) | Full-Knowledge Lockstep With an Optional Referee | Accepted | 2026-09-17 | Networking / Authority |
