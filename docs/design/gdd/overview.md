...
A massive alien vessel crashes into Earth, devastating the impact zone and discharging a catastrophic EMP shockwave that collapses global power grids and electronic infrastructure.
...
## 3. Dynamic World & Global Events

The shared world map features emergent environmental hazards and regional player-driven milestones:
